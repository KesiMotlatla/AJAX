...
public class ComposerData {
    ...
    public ComposerData() {
        ...
        composers.put("1", new Composer("1", "Motati ", "Johann", "Baroque"));
        composers.put("2", new Composer("2", "Palesa", "Thaba", "Classical"));
        composers.put("3", new Composer("3", "Nandi ", "Handel", "Baroque"));
        composers.put("4", new Composer("4", "Ntoa", "Ntoa", "Classical"));
        composers.put("5", new Composer("5", "Philippe", "Raui", "Baroque"));
